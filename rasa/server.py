...
def create_app(
    ...
    @app.get("/IMIM/conversations/<conversation_id:path>/tracker")
    ...
    @app.post("/IMIM/conversations/<conversation_id:path>/tracker/events")
    ...
    @app.put("/IMIM/conversations/<conversation_id:path>/tracker/events")
    ...
    @app.get("/IMIM/conversations/<conversation_id:path>/story")
    ...
    @app.post("/IMIM/conversations/<conversation_id:path>/execute")
    ...
    @app.post("/IMIM/conversations/<conversation_id:path>/trigger_intent")
    ...
    @app.post("/IMIM/conversations/<conversation_id:path>/predict")
    ...
    @app.post("/IMIM/conversations/<conversation_id:path>/messages")
    ...
    @app.post("/IMIM/model/test/stories")
    ...
    @app.post("/IMIM/model/test/intents")
